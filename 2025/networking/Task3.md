...
This document  focuses on launching an Amazon EC2 instance and configuring it's Security Groups to secure your cloud instance. Amazon EC2 (Elastic Compute Cloud) is a scalable compute service provided by AWS(Amazon Web Services), while Security Groups act as virtual firewalls that control inbound and outbound traffic.
...
- Basic understanding of [networking concepts](https://devops-easy.hashnode.dev/mastering-networking-protocols-and-ports)
...
2. Configure basic details:
   - Name: Provide name for your instance according to your task
   - Tags: Add relevant tags for resource management (optional)

3. Choose Amazon Machine Image (AMI):
   - Select "Ubuntu Server 22.04 LTS (HVM)"
   - Filter for "Free tier eligible" (recommended)
...
2. Allow HTTP Traffic: (if needed/optional)
    - Protocol: TCP
    - Port Range: 80
    - Source: Anywhere (0.0.0.0/0)
    - Description: Web access

3. Allow HTTPS Traffic: (if needed/optional)
    - Protocol: TCP
    - Port Range: 8443
    - Source: Anywhere (0.0.0.0/0)
...
Congratulations,You have successfully launched an AWS EC2 instance and configured its Security Groups. 
